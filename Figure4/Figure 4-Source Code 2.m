% Source code used to generate Figure 5b

% sampling frequency
fs = 1000;

% load in trial-level LFP data of the recording
load('/Users/dengyu/Dropbox (Brain Modulation Lab)/Dengyu/Thal_lexicality_paper/CodeandDataAvailability/Figure4/Figure 4-Source Data 2.mat', 'z_oi');
% load in timing info of the trials
load('/Users/dengyu/Dropbox (Brain Modulation Lab)/Dengyu/Thal_lexicality_paper/CodeandDataAvailability/Figure4/Figure 4-Source Data 2.mat', 'epoch_oi');
% load in trial order according to reaction time
load('/Users/dengyu/Dropbox (Brain Modulation Lab)/Dengyu/Thal_lexicality_paper/CodeandDataAvailability/Figure4/Figure 4-Source Data 2.mat', 'ephy_timing');
...
hold on; plot(ephy_timing.ActOn,(1:length(ephy_timing.ActOn)),'b*','MarkerSize',5); % blue for broadband gamma
